...
class SVDModel:
    ...
    def alloc_space(self):
        ...
        if self.param.common_latent_space == 0:
            ...
            self.W_item = self.W_uiset[int(self.param.num_user) + self.ustart: int(self.param.num_item),
                          0:int(self.param.num_factor)]

        else:
            self.W_user = self.W_uiset[self.ustart:int(self.param.num_user), 0:int(self.param.num_factor)]
            self.u_bias = self.ui_bias[self.ustart:int(self.param.num_user)]
            self.W_item = self.W_user
            self.i_bias = self.u_bias
    ...
    def rand_init(self):
        ...
        # TODO:apex_tensor::tensor::sample_gaussian( W_uinit, param.u_init_sigma )
...
# TODO: check # apex_tensor::tensor::sample_gaussian( W_ufeedback, param.ufeedback_init_sigma );
...
class SVDFeatureCSR:
    ...
    # saving object files as binary to harddisk.
    def save_to_file(self):
        pass
    # for i in range(len(self.elems)):
    # pickle.dump((self.elems[i]),open("save.p","wb"))
    # if i == 1000:
    # print("Please have some patient, File saving is in progress")
    # if i == 10000:
    # print("10% of data is saved")
    # elif i == 50000:
    # print("50% of data is saved")
    # elif i == 80000:
    # print("80% of data is saved")
    # print("File saved in Binary Format.")
...
class SVDTrainTask:
    ...
    # self.type_param = apex_svd_model.SVDTypeParam()
    # self.apex_svd_model = apex_svd_model()
    # self.feature = SVDFeatureCSR()
